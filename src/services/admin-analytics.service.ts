...
export class AdminAnalyticsService {
  ...
  public static async getAnalyticsSummary(): Promise<AdminAnalyticsSummaryDTO> {
    const cacheKey = CacheKeyBuilder.adminAnalytics.summary();

    return CacheService.getOrSet(
      cacheKey,
      CACHE_TTL.ADMIN_ANALYTICS.SUMMARY_SECONDS,
      async () => {
  ...
  public static async getCompletedMissionsAnalytics(): Promise<CompletedMissionsAnalyticsDTO> {
    const cacheKey = CacheKeyBuilder.adminAnalytics.completedMissions();

    return CacheService.getOrSet(
      cacheKey,
      CACHE_TTL.ADMIN_ANALYTICS.METRICS_SECONDS,
      async () => {
  ...
  public static async getRevenueAnalytics(): Promise<RevenueAnalyticsDTO> {
    const cacheKey = CacheKeyBuilder.adminAnalytics.revenue();
  ...
  public static async getPilotFleetPerformance(): Promise<PilotFleetPerformanceDTO> {
    const cacheKey = CacheKeyBuilder.adminAnalytics.pilotPerformance();
  ...
  public static async getFarmerGrowth(): Promise<FarmerGrowthAnalyticsDTO> {
    const cacheKey = CacheKeyBuilder.adminAnalytics.farmerGrowth();
  ...
  public static async getPilotPerformanceTable(
    ...
    const cacheKey = CacheKeyBuilder.adminAnalytics.pilotTable(query);

    return CacheService.getOrSet(
      cacheKey,
      CACHE_TTL.ADMIN_ANALYTICS.TABLE_SECONDS,
      async () => {
